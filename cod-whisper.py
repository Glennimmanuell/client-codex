...
class SpeechRecognitionWorker(QThread):
    ...
    def run(self):
        try:
            ...
            print("Rekaman selesai. Mulai transkripsi dengan Whisper...")
            
            # Using standard Whisper transcribe method
            ...
            self.text_signal.emit(transcribed_text if transcribed_text else "Tidak ada suara yang terdeteksi.")
...
class RAGVoiceAssistantApp(QWidget):
    ...
    def initUI(self):
        ...
        self.statusLabel = QLabel("🚀 Menggunakan OpenAI Whisper + Piper TTS", self)
    ...
    def startListening(self):
        ...
        self.statusLabel.setText("🚀 Whisper sedang memproses audio...")
    ...
    def processSpeech(self, text):
        ...
        self.statusLabel.setText("🚀 Menggunakan OpenAI Whisper + Piper TTS")
